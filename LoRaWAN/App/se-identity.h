 ...
 */
#define STATIC_DEVICE_EUI                                  USER_CONF_STATIC_DEVICE_EUI

/*!
 * end-device IEEE EUI (big endian)
 */
#define LORAWAN_DEVICE_EUI                                 USER_CONF_LORAWAN_DEVICE_EUI

/*!
 * App/Join server IEEE EUI (big endian)
 */
#define LORAWAN_JOIN_EUI                                   USER_CONF_LORAWAN_JOIN_EUI
 ...
 */
#define LORAWAN_APP_KEY                                    USER_CONF_LORAWAN_APP_KEY

/*!
 * Network root key
 */
#define LORAWAN_NWK_KEY                                    USER_CONF_LORAWAN_APP_KEY

/*!
 * Forwarding Network session key
 */
#define LORAWAN_NWK_S_KEY                                  USER_CONF_LORAWAN_APP_KEY

/*!
 * Application session key
 */
#define LORAWAN_APP_S_KEY                                  USER_CONF_LORAWAN_APP_KEY
